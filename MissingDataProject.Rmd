---
title: "Missing Data HW3: Please refer to Section 2.c), 3.c) and 4.b) for this Assignment"
author: "Karen Cao"
date: "2/19/2019"
output: pdf_document
---
...
reg.imp = function(x){
  missing = is.na(x)
  imputed = x
  imputed[missing] = pred
  return (imputed)
}

dat$tfr.reg.imp = reg.imp(dat$TFR)
...
Perform regression analysis using 1) complete cases, 2) imputed data where missing values in "TFR" were filled using mean imputation and those in "Recall" were filled using mode imputation and 3) imputed data where missing values in "TFR" were filled using regression imputation. 
